...
export function Projects() {
  ...
  const defaultInfo = {
    ...
    projects: [{"image":"/uploads/project-1762834887680-1762834889268.png","video":"","title":"상업지구 물건 경매 투자 분석","description":"어쩌고 이러하다\n"},{"image":"/uploads/project-1-1762923816621.png","video":"","title":"스타벅스 효과 2.0 (경상북도 상주시) ","detailedDescription":"#### \"스세권\"의 가치는 공시지가보다 빠른가?\n\n**1. \"느린 데이터\"의 한계**\n'스세권'은 통념상 가치가 높지만, 전통적인 '공시지가'는 1년에 한 번 발표됩니다. 시장의 반응을 \"느리게\" 반영합니다.\n\n**2. \"빠른 데이터\"의 포착**\n반면, '네이버 검색량' 등 프롭테크가 활용하는 '빠른 데이터'는 시장의 '관심도'를 \"실시간\"으로 포착합니다.\n\n**3. 시차(Gap) 분석**\n스타벅스 개점일(D-Day)을 기준으로, '빠른 데이터'(검색량)와 '느린 데이터'(공시지가)의 반응 속도를 비교 분석했습니다.\n\n**4. 핵심 결론**\n분석 결과, '빠른 데이터'가 '느린 데이터'를 **최소 6개월~1년 가까이 '선행'함**을 증명했습니다.\n\n**5. 최종 인사이트**\n미래의 감정평가사는 '느린 데이터'와 '빠른 데이터'의 격차(Gap)를 해독하고, '대체 데이터'를 활용하여 시장의 '진짜 가치'를 포착해야 합니다."},{"image":"/uploads/project-1762840776619-1762840778672.png","video":"","title":"경매 물건 투자 보고서","description":"ㅁㅁㅁㅁㅁㅁㅁㅁㅁ"},{"image":"/uploads/project-3-1762925400657.png","video":"","title":"호텔형 실버타운과 미래형 주택 시사점","description":"","detailedDescription": "#### 호텔형 실버타운 연구의 핵심 요약\n\n**1. 연구 배경: 초고령 사회 대비**\n도심형 실버타운의 성공 요인과 한계를 분석하여 미래 노인 주택 모델의 실질적인 대안을 모색했습니다.\n\n**2. 성공 요인 분석**\n'더 시그넘 하우스 강남' 사례를 중심으로, 24시간 간호 서비스, 우수한 부대 시설 및 도심 접근성의 중요성을 파악했습니다.\n\n**3. 세 가지 핵심 문제점 진단**\n높은 **비용** 및 **입주 연령 제한** (경제/시스템), **내부 디자인 인체공학적 미흡** (물리적) 문제를 진단했습니다.\n\n**4. 최종 개선 방안**\n**보증금 분납 시스템** 및 **단계별 케어 시스템** 등 구체적이고 현실적인 재정/운영 개선 방안을 제시했습니다.","pdfUrl":"/uploads/위성민 프로젝트 프롬테크4번.pdf"},{"image":"","video":"","title":"무신사 테라스 입지 분석 (성수, 홍대) ","description":"ㅁㅁㅁㅁㅁ"},{"image":"","video":"","title":"지속가능한 도시 분석","description":"ㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁ"}] as Array<{ image: string; video?: string; title: string; description: string; detailedDescription?: string; }>
  }
  ...
  {index === 0 ? (
    <div className="mt-2 text-sm text-muted-foreground space-y-2">
      <p>
        광교–용인 축의 핵심 상업지에서 경매로 확보한 1층 상가입니다.
      </p>
      <ul className="list-disc list-inside pl-2 space-y-1">
        <li>
          <strong>입지:</strong> GTX-A 구성역·흥덕역 개발 수혜권
        </li>
        <li>
          <strong>경매 메리트:</strong> 감정가 대비 <strong className="text-sky-400">약 30% 할인</strong>
        </li>
        <li>
          <strong>사업 모델:</strong> 베이커리 교습소 + 무인 코인세탁방
        </li>
        <li>
          <strong>수익:</strong> 월 순이익 <strong className="text-sky-400">140~160만 원</strong>
        </li>
      </ul>
      <p>
        <strong>전략:</strong> 
        <span className="font-semibold text-sky-400"> 
          경매 저가 매입 + 개발호재 3~5년 후 시세차익
        </span>
      </p>
    </div>
  ) : index === 1 ? (
    // ▼▼▼ 기존 2번 프로젝트(스타벅스) 코드 그대로 ▼▼▼
    <div className="mt-2 text-sm text-muted-foreground space-y-2">
      <p>

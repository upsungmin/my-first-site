...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"graduation","title":"황지고등학교","period":"2019-2021","description":"일반고 (학교 부회장)"},{"icon":"graduation","title":"단국대학교","period":"2022- 현재","description":"도시계획부동산학부"},{"icon":"award","title":"강원도 도지사배 축구 리그 청소년부 3위 ","period":"2016","description":"."},{"icon":"award","title":"강원도 남북 통일 웅변 대회 금상","period":"2020","description":"강원도도의회 개최"},{"icon":"award","title":"강원도 생할체육대회 검도 부문 금상 외 8개","period":"2010 - 2012","description":"대한검도협회"},{"icon":"award","title":"강원도 학생 영어 스피킹 대회 은상 외 2개","period":"2021","description":"강원도특별자치도교육청"},{"icon":"trophy","title":"투자자산운용사 자격 취득","period":"2025","description":"금융투자협회"},{"icon":"trophy","title":"공인중개사 1차 합격","period":"2025","description":"한국산업인력공단"},{"icon":"user","title":"해병대 병 1302기 전역","period":"2025","description":"병장 만기 전역"}],
